...
$messages['el'] = array(
	...
	'captcha-badlogin' => 'Για την προστασία του βίκι απέναντι σε "σπάσιμο" κωδικών πρόσβασης, παρακαλούμε υπολογίστε αυτό το απλό άθροισμα και γράψτε την απάντηση στο κουτάκι ([[Special:Captcha/help|περισσότερες πληροφορίες]]):',
	'captcha-createaccount' => 'Για την προστασία του βίκι απέναντι σε αυτοματοποιημένη δημιουργία λογαριασμών, παρακαλούμε υπολογίστε αυτό το απλό άθροισμα και γράψτε την απάντηση στο κουτάκι ([[Special:Captcha/help|περισσότερες πληροφορίες]]):',
	...
	'captcha-sendemail' => 'Για την προστασία του βίκι απέναντι σε αυτοματοποιημένες ανεπιθύμητες δημοσιεύσεις, παρακαλούμε υπολογίστε αυτό το απλό άθροισμα και γράψτε την απάντηση στο κουτάκι ([[Special:Captcha/help|περισσότερες πληροφορίες]]):',
