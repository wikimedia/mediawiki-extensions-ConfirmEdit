 ...
 */
$messages['el'] = array(
	'fancycaptcha-createaccount' => 'Για να βοηθήσεις στην προστασία ενάντια στην αυτόματη δημιουργία λογαριασμού, σε παρακαλώ συμπλήρωσε τις λέξεις που εμφανίζονται κάτω στο πλαίσιο ([[Special:Captcha/help|περισσότερες πληροφορίες]]):',
