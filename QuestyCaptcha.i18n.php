 ...
 */
$messages['fa'] = array(
	'questycaptcha-addurl' => 'ویرایش شما شامل پیوند های جدید به بیرون است.
برای محافظت از ویکی در برابر هرزنامه های خودکار, ما از شما خواهش می کنیم که به سوال زیر پاسخ دهید ([[Special:Captcha/help|اطلاعات بیشتر]]):',
	'questycaptcha-badlogin' => 'برای جلوگیری از حدس اتوماتیک رمز عبور, از شما خواهش می کنیم که به سوال زیر پاسخ دهید ([[Special:Captcha/help|اطلاعات بیشتر]]):',
	...
	'questycaptcha-create' => 'برای ایجاد صفحه, لطفا به سوالی که در زیر آمده است پاسخ دهید
([[Special:Captcha/help|اطلاعات بیشتر]]):',
	'questycaptcha-edit' => 'برای ویرایش این صفحه, لطفا به سوال زیر پاسخ دهید
([[Special:Captcha/help|اطلاعات بیشتر]]):',
	'questycaptcha-sendemail' => 'برای حفاظت از ویکی دربرابر هرزنامه های خودکار, از شما خواهش می کنیم که به سوال زیر پاسخ دهید ([[Special:Captcha/help|اطلاعات بیشتر]]):',
	'questycaptchahelp-text' => 'وب سایت هایی که به عموم اجازه نوشتن مطلب می دهند, مانند این ویکی, معمولا توسط هرزنامه فرستندگانی که از ابزار خودکار استفاده می کنند تا به سایت های زیادی پیوند ایجاد کنند, مورد سوءاستفادهٔ قرار می گیرند.
اگر چه این هرزنامه ها را می توان حذف کرد, باعث اعصاب خوردی می شوند.

بعضی اوقات, بخصوص زمانی که در یک صفحه پیوند جدیدی اضافه می کنید, ویکی ممکن از شما سوالی بپرسد.ب
بدلیل این که انجام اینکار برای ابزار های خودکار سخت است, اجازه می دهد که انسان های واقعی در ویکی شرکت کنند در حالی که بیشتر هرزنامه ها و حمله های خودکار متوقف می شود.

در صورتی که سیستم از همکاری شما جلوگیری می کند لطفا با [[Special:ListAdmins|مدیران وبسایت]] تماس بگیرید.

بر روی دکمه "بازگشت" در مرورگر خود فشار دهید تا به صفحه ویرایش برگردید.',
);
