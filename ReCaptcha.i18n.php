...
$messages['ar'] = array(
	...
	'recaptcha-badpass' => 'للمساعدة في حماية ضد الكسر الآلي لكلمة السر، يرجى كتابة الكلمتين التي تراها في المربع أدناه :',
	'recaptcha-createaccount' => 'للمساعدة في الحماية ضد الإنشاء الآلي للحسابات، الرجاء اكتب الكلمتين اللتان تراهما في المربع أدناه:',
	'recaptcha-createaccount-fail' => 'جواب reCAPTCHA غير صحيح أو مفقود.',
	'recaptcha-create' => 'للمساعدة في الحماية ضد الإنشاء الآلي للصفحات، يرجى كتابة الكلمتين التي تراها في المربع أدناه :',
);
