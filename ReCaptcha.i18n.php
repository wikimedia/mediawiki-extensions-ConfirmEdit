...
$messages['mk'] = array(
	...
	'recaptcha-badlogin' => 'Како заштитна мерка против автоматизирано провалување на лозинки, внесете ги двата збора прикажани во полето:',
...
$messages['uk'] = array(
	...
	'recaptcha-badlogin' => 'Для запобігання автоматичному підбору паролю, будь ласка, введіть два слова, які Ви бачите у блоці нижче:',
...
$messages['zh-hant'] = array(
	...
	'recaptcha-badlogin' => '為幫助防止自動密碼破解，請鍵入您看到下面的框中的兩個字：',
